...
export const frenchCV: CVData = {
  ...
  education: [
    ...
    {
      title: "Bac+3 ingénieur du son",
      place: "Cifacom",
      period: "2012 - 2015",
      description: [
        "Formation en ingénierie du son",
      ]
    }
  ],
  experience: [
    ...
    },
    {
      ...
      description: [
        ...
        "Refonte du front (Vue JS) permettant de réduire la latence du site de 80%",
    ...
    },
    {
      ...
      description: [
        "Développement et maintenance d'un SaaS immobilier avec Vue JS / Node JS / TypeScript",
