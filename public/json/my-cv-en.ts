  ...
  experience: [
    {
      ...
      order: 0,
      place: "Jolimoi",
      placeDescription: "Beauty social selling platform (9,000 e-shop users, 5,000 active stylists).",
      ...
      description: [
        "Short-term assignment on a beauty social selling platform generating EUR 3M in annual revenue, with 9,000 e-shop users and 5,000 active stylists.",
    ...
    },
    {
      ...
      description: [
        "Designed and developed from scratch a SaaS platform for a construction group generating around EUR 500k in monthly revenue, reducing operational workload by 50%.",
    ...
    },
    {
      ...
      description: [
        "Built a startup social network for remote workers in 8 months, with several school/freelancer partnerships and press visibility up to Les Echos.",
